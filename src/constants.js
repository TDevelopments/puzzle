...
export const questionsAnswers = [
  [
    {
      question:
        '¿EN LA RESPUESTA DE LANDAU EN QUE MES SE PUEDE INHIBIR LA CONTESTACIÓN VOLUNTARIA?',
      options: [
        {
          id: '1',
          name: 'De 6 a 7 meses',
        ...
        {
          id: '3',
          name: 'De 12 meses a 2 años',
        },
      ],
      answer: '1',
    },
    {
      question: '¿EL REFLEJO LANDAU NO SE CARACTERIZA POR?',
      options: [
        {
          id: '1',
          name: 'Tumbado boca abajo con el abdomen sobre la mano del fisioterapeuta',
        },
        {
          id: '2',
          name: 'El bebé, en lugar de dejarse caer por la gravedad, pone el cuerpo en tensión',
        },
        {
          id: '3',
          name: 'El brazo opuesto se flexiona dobla a la altura del codo y el puño se aprieta',
        },
        {
          id: '4',
          name: 'Colocando el tronco y las piernas en extensión y elevando la cabeza para mirar al frente',
        },
      ],
      answer: '3',
    },
    {
      question: 'EN CABEZA EN VERTICAL, EL TIEMPO CONSIDERADO COMPLETO ES:',
      options: [
        {
          id: '1',
          name: '3 a 6 segundos',
        ...
        {
          id: '2',
          name: '6 a 10 segundos',
        },
        {
          id: '3',
          name: 'Menos de 3 segundos',
        },
      ],
      answer: '2',
    },
  ...
  [
    {
      question:
        '¿EN EL ENDEREZAMIENTO DE CABEZA EN QUE ÁNGULO APROXIMADAMENTE SE INCLINA EL CUERPO?',
      options: [
        {
          id: '1',
          name: '79°',
    ...
    {
      question:
        'EN EL PARACAÍDAS DESCENDENTE DE MIEMBROS INFERIORES LA RESPUESTA COMPLETA ES VISTA ',
      options: [
        {
          id: '1',
          name: '10 meses',
    ...
    {
      question: 'RESPECTO AL ENDEREZAMIENTO DE CABEZA, MARQUE LA CORRECTA',
      options: [
        {
          id: '1',
          name: 'El fisioterapeuta sostiene al niño en suspensión vertical, inclina  el cuerpo despacio hacia un lado y luego el otro a un ángulo',
        },
        {
          id: '2',
          name: 'El fisioterapeuta sostiene al niño en suspensión horizontal, inclina el cuerpo despacio hacia un lado y luego el otro a un ángulo',
        },
        {
          id: '3',
          name: 'El fisioterapeuta sostiene al niño en suspensión vertical, y el niño muestra el reflejo',
        },
      ],
      answer: '1',
    },
  ...
  [
    {
      question:
        'MARQUE LA RESPUESTA INCORRECTA DE EQUILIBRIO EN POSICIÓN PRONO',
      options: [
        {
          id: '1',
          name: 'Es considerada incompleta si solo encorvamiento del tronco se ve',
        },
        {
          id: '2',
          name: 'Es ausente cuando la rotación del tronco del niño no está presente',
        },
        {
          id: '3',
          name: 'Es ausente si ninguna de las respuestas se observa',
        },
      ],
      answer: '2',
    },
    {
      question: 'RESPECTO A LA ROTATIVA DEL CUERPO EN SUPINO',
      options: [
        {
          id: '1',
          name: 'Eche el niño boca abajo y observa la posición de cabeza',
        },
        {
          id: '2',
          name: 'El cuerpo del niño rota la parte superior mientras roda a una posición prona con apoyo de los codos',
        },
        {
          id: '3',
          name: 'Ponga sus manos a nivel del tronco medio, debajo de la axila para prevenir la elevación del hombro',
        },
      ],
      answer: '2',
    },
    {
      question: 'CUAL ES UNA REACCION INCOMPLETA RESPECTO A POSICION PRONA',
      options: [
        {
          id: '1',
          name: 'Si el niño no observa en cualquier dirección, está ausente',
        },
        {
          id: '2',
          name: 'Es incompleta cuando el niño demuestra solo extensión de las piernas o incompleto soporte del peso.',
        },
        {
          id: '3',
          name: 'Considerada incompleta si solo encorvamiento del tronco se ve. Es ausente si ninguna de las respuestas se observa',
        },
      ],
      answer: '3',
    },
